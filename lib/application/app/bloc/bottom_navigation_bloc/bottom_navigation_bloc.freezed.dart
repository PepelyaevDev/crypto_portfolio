...
mixin _$BottomNavigationEvent {
  BottomNavigationKey get key => throw _privateConstructorUsedError;
...
class __$$_BottomNavigationEventCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$_BottomNavigationEvent(
      null == key
          ? _value.key
          : key // ignore: cast_nullable_to_non_nullable
              as BottomNavigationKey,
...
class _$_BottomNavigationEvent implements _BottomNavigationEvent {
  const _$_BottomNavigationEvent(this.key);

  @override
  final BottomNavigationKey key;

  @override
  String toString() {
    return 'BottomNavigationEvent(key: $key)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_BottomNavigationEvent &&
...
mixin _$BottomNavigationState {
  BottomNavigationTab get tab => throw _privateConstructorUsedError;
...
class _$_BottomNavigationState implements _BottomNavigationState {
  const _$_BottomNavigationState(this.tab);
  ...
  @override
  String toString() {
    return 'BottomNavigationState(tab: $tab)';
  }
