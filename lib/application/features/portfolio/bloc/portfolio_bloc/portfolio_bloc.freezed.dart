...
class _$_Success implements _Success {
  const _$_Success({required this.coinsEntity});
  ...
  @override
  String toString() {
    return 'PortfolioState.success(coinsEntity: $coinsEntity)';
  }
...
abstract class _Success implements PortfolioState {
  const factory _Success({required final CoinsEntity coinsEntity}) = _$_Success;
