...
//user data
  ...
  @override
  String toString() {
    return 'CoinEntity(symbol: $symbol, name: $name, image: $image, currentPrice: $currentPrice, marketCap: $marketCap, totalAmount: $totalAmount, moneyInvested: $moneyInvested, history: $history)';
  }
